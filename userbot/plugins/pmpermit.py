...
USER_BOT_WARN_ZERO = "__You were spamming my master's inbox, henceforth you have been blocked__"
USER_BOT_NO_WARN = ("Hello, This Is "
                    f"{DEFAULTUSER}'s Automated Reply Service\n\n"
                    "__My Master will reply you as soon as Possible__\n\n"
                    "__Till then don't Spam the inbox__")

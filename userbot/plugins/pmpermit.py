...
USER_BOT_WARN_ZERO = "`You were spamming my inbox, henceforth you have been blocked by my master's userbot.` "
USER_BOT_NO_WARN = ("Hello, This Is "
                    f"{DEFAULTUSER}'s Automated Reply Service\n\n"
                    "Please do not **SpAm** the inbox\n\n"
                    "My Master will reply you as soon as Possible\n\n"
                    "Tell me what you want, so that I can inform my Master about you"
                   )

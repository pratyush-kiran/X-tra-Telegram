...
async def _(event):
    ...
    if not USER_AFK:  # pylint:disable=E0602
        ...
        if reason:
            ...
            await borg.send_message(event.chat_id, f"**I am Going __Offline__!**")
